...
(function (ts) {
    (function (DeclarationFlag) {
        ...
        DeclarationFlag[DeclarationFlag["HasNoDefaultLib"] = 1 << 8] = "HasNoDefaultLib";
        ...
        function emitDeclarations(writer, jsFilePath, root) {
            ...
            function writeReferencePath(referencedFile) {
                ...
                if (referencedFile.flags & 512 /* DeclarationFile */) {
                    ...
                    declFileName = shouldEmitToOwnFile(referencedFile) ? getOwnEmitOutputFilePath(referencedFile, ".d.json") : ts.getModuleNameFromFilename(compilerOptions.out) + ".d.json"; // Global out file
                }
            ...
            if (root) {
                if (root.hasNoDefaultLib) {
                    writer.writeFlags(ts.DeclarationFlag.HasNoDefaultLib);
                }
