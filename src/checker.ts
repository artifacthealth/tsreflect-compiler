...
module ts {
    ...
    export function createTypeChecker(program: Program, fullTypeCheck: boolean): TypeChecker {
        ...
        function isValidImportDeclaration(node: ImportDeclaration): boolean {
            var symbol = getSymbolOfNode(node);
        ...
        function createResolver(): EmitResolver {
            return {
                ...
                getTypeParametersOfClassOrInterface: getTypeParametersOfClassOrInterface,
                getTypeAliasForTypeLiteral: getTypeAliasForTypeLiteral,
                resolveObjectOrUnionTypeMembers: resolveObjectOrUnionTypeMembers
            };
        }

        function createDeclarationWriter(outputFilePath: string): IDeclarationWriter {

            return new DeclarationWriter(new TextFileWriter(program, outputFilePath));
        }
